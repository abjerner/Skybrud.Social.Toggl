...
namespace Skybrud.Social.Toggl.Endpoints {
    ...
    public class TogglProjectsEndpoint {
        ...
        /// <returns>An instance of <see cref="TogglCreateProjectResponse"/> representing the response from the Toggl API.</returns>
        /// <see>
        ...
        /// <returns>An instance of <see cref="TogglCreateProjectResponse"/> representing the response from the Toggl API.</returns>
        public TogglCreateProjectResponse CreateProject(TogglCreateProjectsOptions options) {
            return TogglCreateProjectResponse.Parse(Raw.CreateProject(options));
        }
