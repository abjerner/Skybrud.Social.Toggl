...
/// </summary>
public class TogglJsonParseException : TogglParseException<JToken> {
    ...
    public TogglJsonParseException(JToken value, string message) : base(value, message) { }
    ...
    public TogglJsonParseException(JToken value, string message, Exception? innerException) : base(value, message, innerException) { }
